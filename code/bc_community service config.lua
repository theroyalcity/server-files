...
Config.ServiceLoaction = vector3((170.0552, -989.230, 30.091)

Config.ServiceLoaction = {
        ...
        { type = "cleannig", coords = vector3(195.5679, -1016.82, 29.359) {,
		...
		{ type = "cleaning", coords = vector3(190.5050, -1003.26, 29.291) {,
