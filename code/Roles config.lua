...
Config.= {}
'use strict';
Kurdistan Royal City Roles
const gulp = require('gulp');
const path = require('path');
const fs = require('fs');player will be revive when role(doctors)use=<cpr>=(animation)<44255>=(command)</revive>will be avabile with<cpr>=(animation)
;player will be handcuff when roles(polices)use=handcuff polices mode menu=in button -_-"handcuff"
